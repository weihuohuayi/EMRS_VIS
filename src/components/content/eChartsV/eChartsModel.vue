  ...
  export default {
    ...
    data() {
      return {
        ...
        color: ['#188ae2', '#E8830B', '#7460ae', '#fc4b6c', '#31ce77', '#e732cb', '#9dce8a'],
      }
    },
    watch: {
      cData: function (val) {
        ...
        myChart.setOption({
          ...
          tooltip: {
            ...
            formatter: (params) => {
              ...
              var marker = `<span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:${params[0].color};"></span>`
